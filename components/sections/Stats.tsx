...
const Stats = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row justify-center items-center h-full w-full gap-1 md:gap-10 lg:gap-1 mx-auto">
        <div className="stats-text font-light text-center lg:text-left whitespace-nowrap mb-4 lg:mb-0">
          You&apos;re Not Alone ―
        </div>
        ...
        {isMobile && (
          <div className="relative w-full max-w-sm mx-auto h-[300px] flex flex-col justify-center items-center text-center">
            <AnimatePresence mode="wait">
              ...
              >
                <motion.h1
                  className="text-[#FF7171] font-bold leading-none mb-4"
                  initial={{ opacity: 0, y: -20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <div className="w-32 h-0.5 bg-[#FF7171] mb-4"></div>
                <motion.p
        ...
        {/* Desktop Version - 3D Cylindrical effect */}
        {!isMobile && (
          <div
            className="relative w-full slider-state max-w-[486px] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px] h-[200px] sm:h-[250px] md:h-[300px] lg:h-[400px] overflow-hidden"
            style={{
